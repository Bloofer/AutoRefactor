...
%type <t> annotation_type_element_declarations
%type <t> resource_list
...
%type <t> annotation_method_or_constant_rest
%type <t> inclusive_or_expression
%type <t> for_statement_nsi
%type <t> try_head
%type <t> generic_constructor_declaration
...
%type <t> block_end
%type <t> enum_constant
%type <t> compilation_unit
%type <t> element_value_pairs
%type <t> class_or_interface_array_type
...
%type <t> annotation_type_element_rest
...
%type <t> generic_method_declaration
...
%type <t> super
%type <t> annotation_type_body
%type <t> annotation_name
%type <t> dims
...
%type <t> generic_abstract_method_declaration
%type <t> switch_label
%type <t> equality_expression
%type <t> type_import_on_demand_declaration
%type <t> modifiers
%type <t> enum_declaration
%type <t> annotation_constant_rest
...
%type <t> modifiers_without_type_parameterization
%type <t> modifier
%type <t> annotation_type_declaration
%type <t> class_body_declarations
%type <t> synchronized
%type <t> abstract_method_declaration
%type <t> annotation_method_rest
...
%type <t> annotation_type_element_non_delimited
%type <t> do_statement
%type <t> element_value_pair
...
%type <t> element_value_array_initializer
%type <t> statement_nsi
%type <t> last_formal_parameter
%type <t> class_declaration
%type <t> while_expression
%type <t> annotation_type_element_declaration
%type <t> switch_block
...
reference_type : class_or_interface_array_type 
    {
        $$= new NonTerminal( 62 );
...
class_or_interface_type : name type_list 
    {
        $$= new NonTerminal( 53 );
...
class_or_interface_array_type : class_or_interface_type dims 
    {
        $$= new NonTerminal( 28 );
...
package_declaration : annotations PACKAGE_TK name SC_TK 
    {
        $$= new NonTerminal( 61 );
...
package_declaration : annotations PACKAGE_TK error 
    {
        $$= new NonTerminal( 61 );
...
package_declaration : annotations PACKAGE_TK name error 
    {
        $$= new NonTerminal( 61 );
...
single_type_import_declaration : IMPORT_TK STATIC_TK name SC_TK 
    {
        $$= new NonTerminal( 83 );
...
single_type_import_declaration : IMPORT_TK STATIC_TK error 
    {
        $$= new NonTerminal( 83 );
...
single_type_import_declaration : IMPORT_TK STATIC_TK name error 
    {
        $$= new NonTerminal( 83 );
...
type_import_on_demand_declaration : IMPORT_TK STATIC_TK name DOT_TK MULT_TK SC_TK 
    {
        $$= new NonTerminal( 134 );
...
type_import_on_demand_declaration : IMPORT_TK STATIC_TK name DOT_TK error 
    {
        $$= new NonTerminal( 134 );
...
type_import_on_demand_declaration : IMPORT_TK STATIC_TK name DOT_TK MULT_TK error 
    {
        $$= new NonTerminal( 134 );
...
annotation : AT_TK annotation_name 
    {
        $$= new NonTerminal( 175 );
...
annotation : AT_TK annotation_name OP_TK element_value CP_TK 
    {
        $$= new NonTerminal( 175 );
...
annotation : AT_TK annotation_name OP_TK element_value_pairs CP_TK 
    {
        $$= new NonTerminal( 175 );
...
annotation : AT_TK annotation_name OP_TK error 
    {
        $$= new NonTerminal( 175 );
...
element_value_pairs : element_value_pairs C_TK element_value_pair 
    {
        $$= new NonTerminal( 27 );
...
element_value_pairs : element_value_pairs C_TK error 
    {
        $$= new NonTerminal( 27 );
...
element_value_pair : identifier EQ_TK element_value 
    {
        $$= new NonTerminal( 165 );
...
element_value_array_initializer : OCB_TK element_value_pairs C_TK CCB_TK 
    {
        $$= new NonTerminal( 179 );
...
element_value_array_initializer : OCB_TK element_value_pairs CCB_TK 
    {
        $$= new NonTerminal( 179 );
...
element_value_array_initializer : OCB_TK CCB_TK 
    {
        $$= new NonTerminal( 179 );
...
annotation_type_declaration : AT_TK INTERFACE_TK identifier annotation_type_body 
    {
        $$= new NonTerminal( 148 );
...
annotation_type_body : OCB_TK annotation_type_element_declarations CCB_TK OCB_TK SC_TK CCB_TK OCB_TK annotation_type_element_declarations error 
    {
        $$= new NonTerminal( 85 );
...
annotation_type_element_declarations : annotation_type_element_declarations annotation_type_element_declaration 
    {
        $$= new NonTerminal( 1 );
...
annotation_type_element_declaration : modifiers annotation_type_element_rest 
    {
        $$= new NonTerminal( 184 );
...
annotation_type_element_rest : type annotation_method_or_constant_rest SC_TK 
    {
        $$= new NonTerminal( 45 );
...
annotation_type_element_rest : annotation_type_element_non_delimited SC_TK 
    {
        $$= new NonTerminal( 45 );
...
annotation_type_element_rest : annotation_type_element_non_delimited 
    {
        $$= new NonTerminal( 45 );
...
annotation_type_element_non_delimited : class_declaration 
    {
        $$= new NonTerminal( 163 );
...
annotation_type_element_non_delimited : interface_declaration 
    {
        $$= new NonTerminal( 163 );
...
annotation_type_element_non_delimited : enum_declaration 
    {
        $$= new NonTerminal( 163 );
...
annotation_type_element_non_delimited : annotation_type_declaration 
    {
        $$= new NonTerminal( 163 );
...
annotation_method_or_constant_rest : annotation_constant_rest 
    {
        $$= new NonTerminal( 12 );
...
annotation_method_rest : identifier OP_TK CP_TK default_value 
    {
        $$= new NonTerminal( 152 );
...
annotation_constant_rest : variable_declarators 
    {
        $$= new NonTerminal( 137 );
...
default_value : DEFAULT_TK element_value 
    {
        $$= new NonTerminal( 56 );
...
type_declaration : annotation_type_declaration 
    {
        $$= new NonTerminal( 153 );
...
modifiers : modifiers_without_type_parameterization 
    {
        $$= new NonTerminal( 135 );
...
modifiers : modifiers_without_type_parameterization type_list 
    {
        $$= new NonTerminal( 135 );
...
modifiers_without_type_parameterization : modifiers_without_type_parameterization modifier 
    {
        $$= new NonTerminal( 146 );
...
class_declaration : modifiers CLASS_TK identifier type_list super interfaces class_body 
    {
        $$= new NonTerminal( 182 );
...
class_declaration : CLASS_TK identifier type_list super interfaces class_body 
    {
        $$= new NonTerminal( 182 );
...
type_list : LT_TK type_parameters GT_TK 
    {
        $$= new NonTerminal( 172 );
...
type_parameters : type_parameters C_TK type_parameter 
    {
        $$= new NonTerminal( 77 );
...
type_parameter : identifier EXTENDS_TK type_bound 
    {
        $$= new NonTerminal( 156 );
...
type_parameter : identifier EXTENDS_TK error 
    {
        $$= new NonTerminal( 156 );
...
type_bound : type_bound AND_TK type 
    {
        $$= new NonTerminal( 80 );
...
class_body_declaration : generic_constructor_declaration 
    {
        $$= new NonTerminal( 119 );
...
class_member_declaration : generic_method_declaration 
    {
        $$= new NonTerminal( 88 );
...
class_member_declaration : enum_declaration 
    {
        $$= new NonTerminal( 88 );
...
generic_method_declaration : type_list method_declaration 
    {
        $$= new NonTerminal( 66 );
...
formal_parameter_list : last_formal_parameter 
    {
        $$= new NonTerminal( 21 );
...
formal_parameter_list : formal_parameter_list C_TK last_formal_parameter 
    {
        $$= new NonTerminal( 21 );
...
last_formal_parameter : type ELLIPSIS_TK variable_declarator_id 
    {
        $$= new NonTerminal( 181 );
...
generic_constructor_declaration : type_list constructor_declaration 
    {
        $$= new NonTerminal( 16 );
...
interface_declaration : INTERFACE_TK identifier type_list interface_body 
    {
        $$= new NonTerminal( 43 );
...
interface_declaration : modifiers INTERFACE_TK identifier type_list interface_body 
    {
        $$= new NonTerminal( 43 );
...
interface_declaration : INTERFACE_TK identifier type_list extends_interfaces interface_body 
    {
        $$= new NonTerminal( 43 );
...
interface_member_declaration : generic_abstract_method_declaration 
    {
        $$= new NonTerminal( 58 );
...
generic_abstract_method_declaration : type_list abstract_method_declaration 
    {
        $$= new NonTerminal( 131 );
...
enum_declaration : ENUM_TK identifier interfaces OCB_TK enum_constants CCB_TK 
    {
        $$= new NonTerminal( 136 );
...
enum_declaration : ENUM_TK identifier interfaces OCB_TK CCB_TK 
    {
        $$= new NonTerminal( 136 );
...
enum_declaration : ENUM_TK error 
    {
        $$= new NonTerminal( 136 );
...
enum_declaration : ENUM_TK identifier error 
    {
        $$= new NonTerminal( 136 );
...
enum_declaration : ENUM_TK identifier interfaces error 
    {
        $$= new NonTerminal( 136 );
...
enum_declaration : ENUM_TK identifier interfaces OCB_TK error 
    {
        $$= new NonTerminal( 136 );
...
enum_declaration : ENUM_TK identifier interfaces OCB_TK enum_constants error 
    {
        $$= new NonTerminal( 136 );
...
enum_constants : enum_constants C_TK enum_constant 
    {
        $$= new NonTerminal( 112 );
...
enum_constants : enum_constants SC_TK 
    {
        $$= new NonTerminal( 112 );
...
enum_constants : enum_constants C_TK error 
    {
        $$= new NonTerminal( 112 );
...
enum_constant : annotations identifier 
    {
        $$= new NonTerminal( 25 );
...
for_statement : for_header type variable_declarator REL_CL_TK expression CP_TK statement 
    {
        $$= new NonTerminal( 22 );
...
for_statement_nsi : for_header type variable_declarator REL_CL_TK expression CP_TK statement_nsi 
    {
        $$= new NonTerminal( 14 );
...
try_statement : try_head block catches 
    {
        $$= new NonTerminal( 155 );
...
try_statement : try_head block finally 
    {
        $$= new NonTerminal( 155 );
...
try_statement : try_head block catches finally 
    {
        $$= new NonTerminal( 155 );
...
resource_list : OP_TK resources CP_TK 
    {
        $$= new NonTerminal( 2 );
...
resources : resources SC_TK resource 
    {
        $$= new NonTerminal( 19 );
...
resource : type variable_declarator 
    {
        $$= new NonTerminal( 33 );
